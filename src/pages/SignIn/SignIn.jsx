				...
				<Grid container item md={8} sm={8} xs={12}>
					...
					<Grid item container md={11} sm={11} xs={11.5}>
						...
						<Grid item container md={12} xs={12} className="signInSectionFoam">
							<Typography variant="h4">Welcome to Candle Thread.</Typography>
							<Grid item container md={12}>
								...
								<Grid item md={5}></Grid>
								<Grid item md={7} sm={9} xs={10.5} className="custom-input-container">
									<Input onKeyPress={handleKeyPress} type={showPassword ? 'text' : "password"} placeholder="Password" value={pass} setValue={setPass} />
									<span className="custom-icon">
								...
								<Grid container item md={7} sm={10} xs={12}>
									...
									<Grid
										...
										md={6}
										sm={6}
										xs={screenWidth > 320 ? 6 : 12}
										style={{
											textAlign: "right",
											display: "flex",
											cursor: "pointer",
											justifyContent: screenWidth > 320 ? "flex-end" : "flex-start",
											paddingRight: "0%",
											alignItems: "center",
											alignContent: "center",
											paddingLeft: "10px",
									...
									>
										<Typography variant="body2" onClick={() => openForgetDialogue()}>
											Forgot Password?
										</Typography>
									</Grid>
								</Grid>
